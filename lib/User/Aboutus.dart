...
class AboutUsPage extends StatelessWidget {
          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                _buildTeamMember(
                  ...
                  'assets/john_doe.jpg', // Replace with your image path
                ),
                _buildTeamMember(
                  'Latifu Ibrahim',
                  'Msanidi Programu',
                  ...
                  'assets/jane_smith.jpg', // Replace with your image path
                ),
                const SizedBox(height: 24),
                const Text(
                  'Wasiliana Nasi',
 ...
 //
 //
 // class Mainju extends StatelessWidget {
 //   @override
 //   Widget build(BuildContext context) {
 //     return Scaffold(
 //       appBar: AppBar(
 //         title: Text('Blood Donation Dashboard'),
